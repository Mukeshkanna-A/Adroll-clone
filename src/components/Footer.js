...
const Footer = () => {
  return (
    <div
      className="d-flex mb-0 mt-3 p-5 flex-column align-items-center justify-content-center"
    ...
    >
      ...
      <p
        ...
        style={{ fontSize: "10.4px", color: "black" }}
      >
        © 2006-2023, NextRoll, Inc. All rights reserved. AdRoll is a division of
