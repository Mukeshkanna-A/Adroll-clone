  ...
  return (
    <div className="mbody">
      ...
      >
        <div className="col-md-6 col-sm-12 col-lg-6  d-flex align-items-center justify-content-center">
          <img
            width={window.innerWidth > 990 ? "450px" : "300px"}
            src="https://www.adroll.com/assets/img/homepage/customers-find.png?format=png&auto=webp&width=398&dpr=2"
            alt=""
          />
        </div>
        ...
        <div className=" pt-4 px-0 col-md-6 col-sm-12 col-lg-6 ">
          <h2
            style={{
              fontSize: window.innerWidth < 990 && "22px",
              color: "#3C4858",
              fontWeight: "600",
              fontFamily: "'Work Sans', sans-serif",
            }}
          ...
          <p
            className="py-3"
            style={{
              fontSize: window.innerWidth < 990 ? "14px" : "16px",
              color: "#3C4858",
            }}
          >
            The AdRoll platform is powered by 15+ years of data from hundreds of
            thousands of brands and billions of shoppers. Let our expertise find
      ...
      >
        <div className="px-0 pt-4 col-md-6 col-sm-12 col-lg-6 ">
          ...
          >
            When we say one-stop shop, we mean one-stop. Launch, pause, and edit
            ad campaigns across all the places you want to advertise, plus use
            that data to see your campaigns holistically and make improvements.
          </p>
          <p
            className="plink"
            style={{
          ...
          >
            Explore ads manager <i className="fa-solid fa-arrow-right"></i>
          </p>
        </div>
        ...
        <div className="col-md-6 col-sm-12 col-lg-6  d-flex align-items-center justify-content-center">
          <img
            width={window.innerWidth > 990 ? "450px" : "250px"}
            src="https://www.adroll.com/assets/img/homepage/save-time.png?format=png&auto=webp&width=398&dpr=2"
            alt=""
          />
        </div>
      </div>
      ...
      >
        <div className="col-md-6 col-sm-12 col-lg-6  d-flex align-items-center justify-content-center">
          <img
            width={window.innerWidth > 990 ? "450px" : "300px"}
            src="https://www.adroll.com/assets/img/homepage/correct-choices.png?format=png&auto=webp&width=398&dpr=2"
            alt=""
          />
        </div>
        ...
        <div className=" px-0 pt-4 col-md-6 col-sm-12 col-lg-6 ">
          ...
          >
            ...
            powerful machine learning makes more predictions per second than the
            NASDAQ to attract the right customers to your site and get them
          ...
          >
            Explore retargeting ads <i className="fa-solid fa-arrow-right"></i>
          </p>
          <p
            className="plink"
            style={{
      ...
      >
        ...
        <div className="col-md-6 col-sm-12 col-lg-6  d-flex align-items-center justify-content-center">
          <img
            width={window.innerWidth > 990 ? "450px" : "300px"}
            src="https://www.adroll.com/assets/img/homepage/experts.png?format=png&auto=webp&width=398&dpr=2"
            alt=""
          />
        </div>
      </div>
      ...
      <div
        className="row m-0 my-5 p-0"
        style={{
          fontFamily: "'Open Sans', sans-serif",
          justifyContent: window.innerWidth > 990 && "space-between",
          border: "15px solid #303273",
        }}
      >
        <div
          className=" px-5 pt-2 col-md-6 col-sm-12 col-lg-6  flex-column d-flex justify-content-center"
          style={{ alignItems: window.innerWidth > 990 ? "start" : "center" }}
        >
          <img
            width={window.innerWidth > 990 ? "200px" : "150px"}
          ...
          <p
            className="pt-4"
            style={{
              fontSize: window.innerWidth < 990 ? "16px" : "18px",
              color: "#3C4858",
              textAlign: window.innerWidth < 990 && "center",
            }}
          >
            "Since last year, our revenue has increased 191%,
            <b> our attributed conversions 177%,</b> and our{" "}
            <b> engagement 33%.</b> We’re reaching and converting customers
            higher in the funnel."{" "}
          </p>
        </div>
        <div className=" p-0 col-md-6 col-sm-12 col-lg-6  pimg">
          <p style={{ fontSize: window.innerWidth < 990 ? "33px" : "30px" }}>
            <b>AdRoll customers</b> make <br />
            <span
              style={{ fontSize: window.innerWidth < 990 ? "58px" : "72px" }}
            >
              <b>$165B</b>
            </span>
            <br />
      ...
      <div className="my-5 d-flex align-items-center justify-content-center flex-wrap">
        <img
          width={window.innerWidth > 990 ? "150px" : "75px"}
      ...
      >
        <h2
          ...
          style={{ fontSize: "28px", fontWeight: "700", color: "#3C4858" }}
        >
        ...
        <div className="py-2 d-flex justify-content-between ">
          <button
            style={{
              fontSize: window.innerWidth > 990 ? "small" : "8px",
              padding: window.innerWidth > 990 ? "14px 28px" : "10px 14px",
            }}
            className="btn rounded-2 btn-purp"
          >
            GET STARTED
